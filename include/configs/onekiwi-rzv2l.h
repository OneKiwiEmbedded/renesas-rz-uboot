...
#ifndef __ONEKIWI_RZV2L_H
#define __ONEKIWI_RZV2L_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"emmcload=ext4load mmc 0:2 0x48080000 boot/Image;ext4load mmc 0:2 0x48000000 boot/onekiwi-rzv2l.dtb;run prodemmcbootargs \0" \
	"sd1load=ext4load mmc 1:2 0x48080000 boot/Image;ext4load mmc 1:2 0x48000000 boot/onekiwi-rzv2l.dtb;run prodsdbootargs \0" \
	"usbload=ext4load usb 0:2 0x48080000 boot/Image;ext4load usb 0:2 0x48000000 boot/onekiwi-rzv2l.dtb;run produsbbootargs \0" \
