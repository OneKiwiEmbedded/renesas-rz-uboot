...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"emmcload0=ext4load mmc 0:2 0x48080000 boot/Image;ext4load mmc 0:2 0x48000000 boot/onekiwi-rzv2h-8gb.dtb;run prodemmcbootargs \0" \
	"sd0load0=ext4load mmc 0:2 0x48080000 boot/Image;ext4load mmc 0:2 0x48000000 boot/onekiwi-rzv2h-8gb.dtb;run prodsd0bootargs \0" \
	"sd1load0=ext4load mmc 1:2 0x48080000 boot/Image;ext4load mmc 1:2 0x48000000 boot/onekiwi-rzv2h-8gb.dtb;run prodsd1bootargs \0" \
	...
	"usbload0=ext4load usb 0:2 0x48080000 boot/Image;ext4load usb 0:2 0x48000000 boot/onekiwi-rzv2h-8gb.dtb;run produsbbootargs \0" \
