...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"emmcload=ext4load mmc 0:2 0x48080000 boot/Image;ext4load mmc 0:2 0x48000000 boot/onekiwi-rzv2h-16gb.dtb;run prodemmcbootargs \0" \
	"sd0load=ext4load mmc 0:2 0x48080000 boot/Image;ext4load mmc 0:2 0x48000000 boot/onekiwi-rzv2h-16gb.dtb;run prodsd0bootargs \0" \
	"sd1load=ext4load mmc 1:2 0x48080000 boot/Image;ext4load mmc 1:2 0x48000000 boot/onekiwi-rzv2h-16gb.dtb;run prodsd1bootargs \0" \
	"bootusb=usb start; run usbload; run bootimage \0" \
	"usbload=ext4load usb 0:2 0x48080000 boot/Image;ext4load usb 0:2 0x48000000 boot/onekiwi-rzv2h-16gb.dtb;run produsbbootargs \0" \
